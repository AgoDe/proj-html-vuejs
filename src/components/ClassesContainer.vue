                ...
                <div>
                    ...
                    <div class="info">
                        <div>
                            ...
                            <div class="item-title">{{item.old_measure}}</div>
                        </div>

                        <div>
                            <div class="item-data">{{item.class_size}}</div>
